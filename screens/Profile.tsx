...
const Admin = styled.View<{ isDark: boolean }>`
    height: 40px;
    align-items: center;
    justify-content: center;
    margin-top: 20px;
...
const NoticeView = styled.View<{ isDark: boolean }>`
    margin: 0px 20px;
    padding: 20px 10px;
    border-width: 1px;
    border-radius: 5px;
...
const TitleView = styled.View<{ isDark: boolean }>`
...
const CardCertification = styled.View<{ isDark: boolean }>`
    height: 40px;
    align-items: center;
    justify-content: center;
    margin-top: 20px;
...
const IdCertification = styled.View<{ isDark: boolean }>`
    height: 40px;
    align-items: center;
    justify-content: center;
    margin-top: 20px;
    ...
    return (
        <Container>
            <NoticeView isDark={isDark}>
                <Notice>
                    IDCatch는 주류 판매에 대한 지문 인증 APP 입니다. 해당 APP은 미성년자 주류 판매를 제한하는 다중 인증 시스템 APP으로
