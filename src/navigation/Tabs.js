            ...
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused, color, size }) => {
                        return <FontAwesome name={focused ? "user-circle" : "user-circle-o"} color={color} size={size} />;
                    },
                }}
            />
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused, color, size }) => {
                        return <Ionicons name={focused ? "checkmark-circle" : "checkmark-circle-outline"} color={color} size={size} />;
                    },
                }}
            />
            <Tab.Screen
